...
bma <- function (data,
  ...
  switch(tolower(model),
         ...
         bma_model_test = {bugs_path <- bma_model_test()},
         {stop("model type not know. Must be one of 'random_walk', 'uniform', 'uniform_noeta', 'bma_model_test'")})
  ...
  params = c("tau.b0", "tau.eta", "tau.I", "logI", "alpha", "alpha.b0", "se")
